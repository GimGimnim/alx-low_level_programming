...
File 100-print_comb2.c is a C program that prints the numbers from 00 to 99.

File 101-print_comb3.c is a program that prints all possible different combinations of two digits.

File 102-print_comb4.c is a program that prints all possible different combinations of three digits.

File 103-print_comb5.c is a program that prints all possible combinations of two two-digit numbers.
